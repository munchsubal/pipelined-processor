...
wire shifted;
assign shifted = (i<2) ? 1'b0 : s1[i-2];
...
wire shifted;
assign shifted = (i<4) ? 1'b0 : s2[i-4];
...
wire shifted;
assign shifted = (i<8) ? 1'b0 : s3[i-8];
...
wire shifted;
assign shifted = (i<16) ? 1'b0 : s4[i-16];
...
wire shifted;
assign shifted = (i<32) ? 1'b0 : s5[i-32];
